...
The extend keyword takes care of extending the parent class to its subclass, the super keyword is used to make sure that the subclass is called via the main's constructor to inherit the characteristics and behaviors of the main.
