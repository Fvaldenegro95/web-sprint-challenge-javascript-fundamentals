...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach(element => {
      let displayName = `name: ${element.animal_name}, scientific: ${element.scientific_name}`
  ...
  */
  ...
  function lowerCaseNames(lowerCase){
    const newArray = lowerCase.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(lowPopulation){
    const newArray = lowPopulation.filter(function(item){
